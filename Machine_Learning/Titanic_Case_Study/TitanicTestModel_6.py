...
#---------------------------------------------------------------------------------------#
# Function name : def LoadPresrveModel()
# Description   : it is used to load model
# Parameters    : filename
...
def TrainTitanicModel(df):
    ...
    print("\nCoefficent of model")
    for feature,coefiecent in zip(X.columns, model.coef_[0]):
        print(feature, " : ", coefiecent)


    PreserveModel(model, "marvelloustitanic.pkl")

    loaded_model = LoadPresrveModel("marvelloustitanic.pkl")
