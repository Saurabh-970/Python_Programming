...
#-------------------------------------------------------------------------------------------------#
    ...
    def issue_book_gui(self, book_id, borrower):
        ...
        for book in self.books:
            ...
            if book.book_id == book_id:
                ...
                return True, f'"{book.name}" has been issued to {borrower}.'
    ...
    def return_book_gui(self, book_id):
        ...
        return True, f'"{book.name}" returned successfully from {borrower}.'


    def remove_book_gui(self, book_id):
        ...
        if not book.available:
            return False, "Cannot remove an issued book."

        self.books.remove(book)

        self.save_books()

        return True, f'"{book.name}" removed successfully.'


    def search_book_gui(self, keyword):
        ...
        for book in self.books:
            ...
            if (
                keyword in str(book.book_id).lower()
                or keyword in book.name.lower()
